package client.updater.asm.controlflow.RedundantMethod;

import client.api.util.Logging;
import client.updater.asm.controlflow.Generic.DeobFrame;
...
public class MethodRemoval extends DeobFrame {
    ...
    public List<MethodWrapper> getRedundantMethods() {
        ...
        Logging.status(" -# Removed "+ Integer.toString(toRemove.size()) + "/" + Integer.toString(all.size()) + " redundant methods!");
        return toRemove;
    }
