...
public class Rasterizer extends ClassIdentifier {
    private static MethodDescription rasterizerClassMethods[] = new MethodDescription[]{
    };
    ...
    public void identify(HashMap<String, ClassData> clientClasses) {
        ...
        for (ClassData cd : clientClasses.values()) {
            ...
            if (nonstatic == 0 && UpdaterMain.getUpdater().findInstanceCount("L" + cn.name + ";") == 0 && fieldsIdentified() && isMatch(cn, rasterizerClassMethods)) {
